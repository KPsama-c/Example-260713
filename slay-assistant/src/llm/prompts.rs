...
## 分析原则
- 先识别角色流派（铁甲：力量/壁垒/消耗/自残；静默：毒/飞刀/弃牌/虚无；缺陷：闪电/冰/爪/黑暗；以及摄政/死灵等新角色）
- 选牌优先流派核心牌，Skip 稀释牌组的基础打击/防御
- 过牌：留引擎/能量/防；扔高费无协同与重复基础牌
- 出牌：Power/Debuff 先于输出；高威胁意图先格挡
- 地图：血线、商店、精英、篝火与流派成型速度
- 能量效率：每点能量的伤害/格挡
"#;
